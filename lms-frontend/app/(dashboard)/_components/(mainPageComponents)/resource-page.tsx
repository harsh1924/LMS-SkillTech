...
export const ResourcePage = () => {
    ...
    return (
        <span>
            <div className="hover:text-[#347bdc] ease-in-out transition-all duration-300 z-50 py-2 rounded-sm lg:flex items-center gap-x-2 hidden group relative cursor-pointer">
