    ...
    return (
        <div className="flex flex-col gap-y-6 w-full h-[602px] overflow-y-scroll no-scrollbar">
            <div className="flex flex-wrap gap-x-6 gap-y-4">
                {categoryCourses.map((course: { title: string; imageUrl: string; isPublished: boolean; _id: string; skillsOne: string; skillsTwo: string; skillsThree: string; duration: number; isFree: boolean }) =>
