...
const InstructorForm = () => {
    return (
        <div>
            <HomeNavbar />
            <div className="px-20 py-14 bg-sky-500 text-white">
                <h1 className="text-4xl font-sans md:text-6xl">
                    Teach. Create. Earn.
                </h1>
            </div>
            <div className="py-10 flex justify-center items-center">
                <div className="py-6 px-5 rounded-md shadow-[0_0_10px_black] flex justify-center items-center flex-col border">
