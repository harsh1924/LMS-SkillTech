...
export const SearchPageCourses = ({
    ...
    return (
        <>
            <Link href={`course/${id}/course-details`} className="flex flex-col w-[600px]">
                <div className="flex gap-y-3 items-center">
                    <div className="py-10 w-full lg:px-8 flex flex-row-reverse gap-x-4 items-center justify-center border rounded-md h-[280px]">
                        <div className="flex gap-y-1 flex-col px-4 py-6 justify-between h-[200px]">
                            <p>
                                <span className="text-lg oxygen-bold font-sans">
                                    {title}
                                </span>
                            </p>
                            <p>
