...
const AddLecturesPage = ({
    ...
    return (
        <div className="flex flex-col items-center gap-y-10">
            ...
            <div>
                <Link href={`/trainer/courses/${params.courseId}/edit-course/add-lectures/view-lectures`} className="px-4 py-3 border-b border-sky-500 hover:text-white hover:bg-sky-500 transition-all ease-in-out duration-300 rounded-sm">
                    Edit Lectures
                </Link>
            </div>
        </div>
